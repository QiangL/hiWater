    ...
    */
    ...
    writeIncludes: function () {
        var me = this,
            ...
            suffix = '',
            bootstrap = '';
        var linkExtCSS = document.getElementById("linkExtCSS").href;
        var folderPathLenth = linkExtCSS.lastIndexOf('/');
        var extensiblePath = linkExtCSS.substring(0, folderPathLenth) + "/extensible-all.css";
        me.includeStylesheet(extensiblePath);
        me.includeScript(UrlConvert('Scripts/Extjs4/extensible-all-debug.js'));
        me.includeScript(UrlConvert('Scripts/Extjs4/ext-lang-zh_CN.js'));
        me.includeScript(UrlConvert('Scripts/Extjs4/extensible-lang-zh_CN.js'));
