...
*/
Ext.define('SinoydFramework.view.portal.PortalPanel', {
    ...
    cls: 'x-portal',
    bodyCls: 'x-portal-body-noborder',
    ...
    initEvents: function () {
        this.callParent();
        this.dd = Ext.create('SinoydFramework.view.portal.PortalDropZone', this, this.dropConfig);
    },
    ...
    beforeDestroy: function () {
        ...
        SinoydFramework.view.portal.PortalPanel.superclass.beforeDestroy.call(this);
    }
});
