...
public class Valley {
	...
	private String txtValleyCode;
	private String txtValleyName;
	...
	@Column(name = "txtValleyCode")
	public String getTxtValleyCode() {
		return txtValleyCode;
	}
	public void setTxtValleyCode(String txtValleyCode) {
		this.txtValleyCode = txtValleyCode;
	}
	@Column(name = "txtValleyName")
	public String getTxtValleyName() {
		return txtValleyName;
	}
	public void setTxtValleyName(String txtValleyName) {
		this.txtValleyName = txtValleyName;
	}
